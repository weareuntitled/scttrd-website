...
const homeId=await upsertPage(token,'home',{
  ...
  bio_de:lex('Wir sind SCTTRD. Producer Dani, Vocalistin Babsi und Drummer Nate. Unser Sound pendelt zwischen düsterem Post-Punk, hartem Techno und melodischem Trance. Wir liefern einen Mix aus deutschen und englischen Texten, irgendwo zwischen NDW 2.0 und Underground. Brutal, aber schön!'),
  ...
  text:'Brutal, aber schön.',email:'info@scttrd.de',
